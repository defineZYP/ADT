...
The dataset used for SASRec backbone and Bert4Rec backbone is uploaded in the repository. For STOSA backbone, you can download the 5-score dataset from [Amazon Dataset](https://jmcauley.ucsd.edu/data/amazon/) or go to the [original repository](https://github.com/zfan20/STOSA) for the details.